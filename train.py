...
parser.add_argument('--test', default="cpy0126.MyAgentR")
...
for i in range(args.f,args.t+1,args.s):
	results=str(subprocess.check_output(['python3','my_arena.py','--agent1',args.test,'--agent2',args.agent2,'--rounds',str(args.rounds),'--headless','--control',str(i)]))
